<?php
/**
 * Plugin Name: All-in-One Post SEO Webhook & API Manager - Fixed Original
 * Plugin URI: https://wordpress.org/plugins/all-in-one-post-seo-webhook-api-manager/
 * Description: Complete webhook management solution with SEO integration, API endpoints, and automation tools for WordPress posts - Fixed Version
 * Version: 2.0
...
// Include required files (using simple logger)
...
// Activation hook - SIMPLIFIED WITHOUT DATABASE
