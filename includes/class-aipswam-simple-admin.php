<?php
/**
 * Simple Admin Class with pure JavaScript (no jQuery dependencies)
 *
...
class AIPSWAM_Simple_Admin {
        ...
        <div class="wrap">
            ...
            <div class="aipswam-tabs">
                <nav class="nav-tab-wrapper">
                    <a href="#general" class="nav-tab nav-tab-active" onclick="showTab('general')">
                        <span class="dashicons dashicons-admin-settings"></span>
                        <?php _e('Configuration', 'all-in-one-post-seo-webhook-api-manager'); ?>
                    </a>
                    <a href="#triggers" class="nav-tab" onclick="showTab('triggers')">
                        <span class="dashicons dashicons-update"></span>
                        <?php _e('Triggers', 'all-in-one-post-seo-webhook-api-manager'); ?>
                    </a>
                    <a href="#api" class="nav-tab" onclick="showTab('api')">
                        <span class="dashicons dashicons-rest-api"></span>
                        <?php _e('API Endpoints', 'all-in-one-post-seo-webhook-api-manager'); ?>
                    </a>
                    <a href="#keywords" class="nav-tab" onclick="showTab('keywords')">
    ...
    "keywords": ["primary keyword", "secondary keyword 1", "secondary keyword 2"]
            ...
            <script type="text/javascript">
                // Tab functionality with pure JavaScript
                ...
                function generateSecret() {
                    ...
                    document.getElementById('aipswam_webhook_secret').value = secret;
                }
            </script>
        </div>
        <?php
