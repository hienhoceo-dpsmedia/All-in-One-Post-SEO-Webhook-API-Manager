<?php
/**
 * Plugin Name: All-in-One Post SEO Webhook & API Manager - FINAL WORKING VERSION
 * Plugin URI: https://wordpress.org/plugins/all-in-one-post-seo-webhook-api-manager/
 * Description: Complete webhook management solution with SEO integration, API endpoints, and automation tools for WordPress posts - FINAL GUARANTEED WORKING VERSION
 * Version: 2.2.0
...
// Activation hook - completely simplified and guaranteed to work
